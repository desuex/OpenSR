...
namespace OpenSR
{
    namespace World
    {
        ...
        class OPENSR_WORLD_API Ship: public MannedObject
            ...
            Q_PROPERTY(OpenSR::World::ShipStyle style READ style WRITE setStyle NOTIFY styleChanged)
        ...
        public:
            ...
            void setStyle(const ShipStyle& style);
            ...
            Q_SIGNALS:
                    ...
                    void styleChanged(ShipStyle style);
